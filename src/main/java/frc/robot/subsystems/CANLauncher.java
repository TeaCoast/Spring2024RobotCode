...
public class CANLauncher extends SubsystemBase {
   ...
   */
  public Command getLaunchCommand(double feedSpeed, double launchSpeed, double delay) {
    return this.startEnd(() -> setLaunchWheel(launchSpeed), () -> {})
               .withTimeout(delay)
               .andThen(this.startEnd(() -> setFeedWheel(feedSpeed), () -> {}))
